...
import com.example.audiotopapp.ListeAudioActivity;
...
public class CategorieAdapter extends
    ...
    private List<Categorie> mContacts;

    // Pass in the contact array into the constructor
    public CategorieAdapter(List<Categorie> contacts) {
        mContacts = contacts;
    }
    ...
    public void onBindViewHolder(CategorieAdapter.ViewHolder holder, int position) {
        ...
        Categorie contact = mContacts.get(position);

        // Set item views based on your views and data model
        TextView textView = holder.nameTextView;
        textView.setText(contact.getNom());
        TextView audioCount = holder.totalTextView;
        if (contact.getFichierTotal() == 0)
        audioCount.setText("Aucun audio");
        else
        audioCount.setText(contact.getFichierTotal() + " audio(s)");
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(view.getContext(), ListeAudioActivity.class);

                intent.putExtra("categorie_id", contact.getId());
                intent.putExtra("categorie_name", contact.getNom());
